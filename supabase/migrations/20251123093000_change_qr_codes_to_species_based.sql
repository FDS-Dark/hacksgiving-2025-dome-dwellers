-- Migration: Rename species_id to plant_species_id and add location support
-- This aligns the database column names with our API layer

-- Drop existing unique constraint on species_id if it exists
ALTER TABLE gamification.qr_codes
DROP CONSTRAINT IF EXISTS qr_codes_species_id_key;

ALTER TABLE gamification.qr_codes
DROP CONSTRAINT IF EXISTS qr_codes_species_id_unique;

-- Rename species_id to plant_species_id
-- ALTER TABLE gamification.qr_codes
-- RENAME COLUMN species_id TO plant_species_id;
...
-- Add indexes for plant_species_id and location_id lookups
