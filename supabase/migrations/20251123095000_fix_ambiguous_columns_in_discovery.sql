-- Migration: Fix ambiguous column references in discover_plant_from_qr
-- This fixes the issue where PostgreSQL can't distinguish between variables and columns
